...
impl Traversal {
    ...
    pub fn extract<'a>(&self, input: &'a str) -> HashMap<&'static str, &'a str> {
        self.positions
            .iter()
...
impl<T> StateMachine<T> {
    ...
    pub fn set_handler(&mut self, index: usize, handler: T) {
    ...
    pub fn process<'m>(&'m self, input: &'m str) -> Option<Match<'m, T>> {
